<script setup>
  ...
  import BottomBtn from '@/components/target/BottomBtn.vue'
      ...
      <div v-else class="message-area">
          ...
          <div class="message-form-wrap">
            <div class="cnt-title subtitle-20">
              <b class="title">RCS 하단 버튼</b>
              <small class="text-sm mo-next">(최소1건~최대 3건, 노출 순서대로 입력)</small>
            </div>
            <BottomBtn :data="data.bottomBtn" @alert="(v)=>{emits('alert', v)}" />
