        ...
        <div class="phone">
          <div class="screen">
            ...
            <div class="insert-form-wrap no-line-b">            
                ...
                <div v-if="data.src" class="upload-image">
                  <button class="btn-del" @click="data.src = ''"></button>
                  <img :src="data.src" alt="">
                </div>
                <button v-else class="btn-image-upload">
                  <input type="file" @change="readInputFile">
                  <i></i>
                  <div class="text">
                    <b>MMS 이미지</b>
                    <p><span>크기 480 x 720 px</span><span>확장자 jpg, png, gif</span></p>
                  </div>
                  <span class="btn-st">불러오기</span>
                </button>       
