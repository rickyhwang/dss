...
const department = ref('디자인팀');
const departmentRules = ref(['부서명을 입력해주세요.']);
</script>
...
<template>
  <div class="sub-group my-page">
        ...
        <Form class="form-wrap">
          <div class="form-box">
            ...
            <div class="form-group">
              ...
              <div class="data-wrap">
                <span class="data">husjhd@shinhancard.com</span>
              </div>
            </div>
            <div class="form-group">
              <div class="ele-tit">
              ...
              <div class="check-wrap">
                ...
                <div class="agree-btn">
                  <v-btn variant="text">
                    마케팅동의 약관<v-icon class="btn-arrow" />
                  </v-btn>
                </div>
              </div>
            </div>
    ...
    <div class="my-info">
      <div class="title">
        <v-icon size="md" class="icon-business" />기업정보
      </div>
      <div class="member">
        <Form class="form-wrap">
          <div class="form-box">
            <div class="form-group">
              ...
              <div class="data-wrap">
                <span class="data">(주)신한카드</span>
              </div>
            </div>
            <div class="form-group">
              <div class="ele-tit">
                <v-label>사업자등록번호</v-label>
              </div>
              <div class="data-wrap">
                <span class="data">222-86-11165</span>
              </div>
            </div>
            <div class="form-group">
              <div class="ele-tit">
              ...
              <!-- <p class="text-tip error">부서명을 입력해주세요.</p> -->
            </div>
            <div class="form-group">
              <div class="ele-tit">
                <v-label>법인 도메인</v-label>
              </div>
              <div class="data-wrap">
                <span class="data">shinhancard.com</span>
              </div>
            </div>
          </div>
        </Form>
